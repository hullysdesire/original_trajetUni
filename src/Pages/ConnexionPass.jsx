...
export default function ConnexionPass () {
    return (
      <div>
                  ...
                  <div className="g-0 lg:flex lg:flex-wrap ">
                    ...
                    <div className="px-4 md:px-0 lg:w-6/12  ">
                      <div className="md:mx-6 md:p-300 overflow ">
                        ...
                        <div className="text-center   ">
                          ...
                          Connectez vous en tant que Passager pour profiter 
                        ...
                        <form>
                          ...
                          <div className="mb-12 pb-1 pt-1 text-center">
                            <a href="/InscriptionPass"><button className="mb-3 inline-block w-full rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_rgba(0,0,0,0.2)] transition duration-150 ease-in-out hover:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:outline-none focus:ring-0 active:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)]" type="button" data-te-ripple-init data-te-ripple-color="light" style={{background: "linear-gradient(to right, #ee7724, #d8363a, #dd3675, #b44593)"}}> Connexion </button></a>
                          ...
                          <div className="flex items-center justify-between pb-6 ">
                            ...
                            <a href="/InscriptionPass"><button type="button" className="inline-block rounded border-2 border-danger px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-danger transition duration-150 ease-in-out hover:border-danger-600 hover:bg-neutral-500 hover:bg-opacity-10 hover:text-danger-600 focus:border-danger-600 focus:text-danger-600 focus:outline-none focus:ring-0 active:border-danger-700 active:text-danger-700 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10" data-te-ripple-init data-te-ripple-color="light">Créer un compte</button></a>
                          </div>
                        </form>
                      </div>
                    </div>
                    ...
                    <div className="hidden lg:flex flex items-center rounded-b-lg lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none" style={{background: "linear-gradient(to right, #ee7724, #d8363a, #dd3675, #b44593)"}}>
                      <div className="px-4 py-6 text-white md:mx-6 md:p-12">
                        ...
                        <p className="text-sm">
                         TrajetUni est la plateforme Gabonaise qui vous permet trouver un trajet quotidien afin de vous deplacer en toute securité !                        </p>
                      </div>
                    </div>
                  </div>
                </div>
