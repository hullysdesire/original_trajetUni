    ...
    return(
        <>
           <div className=" flex ">
                ...
                <h2 className="text-4xl font-medium leading-tight text-center font-bold mt-4 mb-10 text-center flex-auto">Mes status</h2>
            </div> 
            <Search/>

            <img src="src/assets/Free Vector _ Man standing by car with cityscape in background (1).jpg" alt="" className="m-auto" />
            <p className="m-auto mt-5 mb-5 text-center">Vous n'avez aucune reservation en cours</p>
